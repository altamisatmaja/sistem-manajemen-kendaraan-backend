    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="lg:hidden items-center flex py-4">
            <ul class="space-y-2 mx-auto">
                <li
                    class="flex py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-white ">
                    <a href="{{ route('dashboard') }}" class="block text-gray-800 mx-auto  truncate transition">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960"
                                width="30px" fill="#1f2937">
                                <path
                ...
                <li class="flex flex-col mx-auto mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))]"
                    ...
                    <a class="block rounded-lg pl-3 pr-3 py-2 text-gray-800 hover:bg-orange-400  truncate transition @if (!in_array(Request::segment(1), ['tasks'])) {{ 'hover:text-gray-900 ' }} @endif"
                ...
                <li
                    class="pl-3 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-white ">
                ...
                <div class="space-y-2 pt-2 border-t-2 border-gray-200">
                    <li
                        class="pl-3 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-gray-100 ">
                        <a class="block text-gray-800  truncate transition" href="{{ route('admin.dashboard') }}">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960"
                                    width="30px" fill="#1f2937">
                    ...
                    <li
                        class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-gray-100 ">
                        <a class="block text-gray-800  truncate transition" href="{{ route('admin.dashboard') }}">
                            <div class="flex items-center">
